...
| ---------------------------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Repo configuration and command surface                     | Synthesized | `package.json`, `COMMANDS.md`, `justfile`, `.github/workflows/*.yml`                                                             | `just` is now the human and CI command surface. Roadmap focuses on command taxonomy, artifact lifecycle, and CI signal routing.                                        |
...
| Styles, tokens, prose, print, and theme layers             | Synthesized | `src/styles/global.css`, `src/styles/print.css`, `site/theme.css`, `docs/authoring/SITE_THEME_CONTRACT.md`                       | Token model is clear. Roadmap adds theme validation, recipe tokens, and print/prose contracts as reusable platform surfaces.                                           |
...
| Accessibility, semantic HTML, and machine readability      | Synthesized | `agent-docs/audits/METADATA_SEMANTICS_ACCESSIBILITY_AUDIT.md`, `src/lib/metadata.ts`, `src/lib/semantic-metadata.ts`, a11y tests | Metadata and semantics are strong. Roadmap creates extensible semantic profiles and AI-readable content manifests.                                                     |
| Future extractability/package candidates                   | Synthesized | `docs/platform/PLATFORM_MODULES.md`, platform boundary checker, mature lib domains                                               | Multiple candidates are ready for internal package boundaries before external publication.                                                                             |
| Mature product/platform gap pass                           | Synthesized | `agent-docs/core/ENGINEERING_PHILOSOPHY.md`, roadmap gap reread                                                                  | Added first-class roadmap domains for extensions, authoring studio, import/export, deployment governance, security/privacy, observability, localization, and starters. |
