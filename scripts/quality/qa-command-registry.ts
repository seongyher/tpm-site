...
export const qaCommandGroups = [
  ...
  },
  {
    ...
    scripts: ["docs:check", "docs:references:check"],
  },
  {
    ciUsage: "none",
    class: "mutation",
  ...
  },
  {
    ...
    mutation: "generated-output",
    runtime: "slow",
    scope: "Example documentation site validation and build.",
    scripts: ["docs-site:build", "test:docs-site"],
  },
  {
    ciUsage: "none",
    class: "investigation",
    ...
    mutation: "local-server",
    runtime: "external",
    scope: "Local documentation-site development and preview servers.",
    scripts: ["docs-site:dev", "docs-site:preview", "docs-site:preview:fresh"],
  },
  {
    ciUsage: "none",
    class: "mutation",
...
export const qaCiJobRegistry = [
  ...
  {
    blocking: true,
    ciCommandSnippets: ["bun run docs:check"],
    job: "docs-site",
    localScripts: ["docs:check"],
...
export const qaDomainCoverageRegistry = [
  ...
  },
  {
    ...
    domain: "docs",
    focusedScripts: ["docs:check", "docs:references:check"],
  ...
  },
  {
    ciJobs: ["docs-site"],
    domain: "docs-site",
    focusedScripts: ["docs-site:build", "test:docs-site"],
