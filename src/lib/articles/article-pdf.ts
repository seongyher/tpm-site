import { articleCompilerArtifact } from "../content/article-compiler";
import type { AuthorSummary } from "../content/authors";
import { absoluteUrl } from "../metadata/seo";
import type { ArticleReferenceData } from "../references/article-references/model";
import { normalizedCitationSource } from "../references/article-references/source";
import { routeOutputBasePath } from "../routes/route-registry";
import { type ArticleEntry, authorName } from "../routes/routes";
