...
} from "../articles/article-pdf";
import type { ArticleTableOfContentsHeading } from "../articles/article-toc";
import {
  type SocialPreviewImage,
  type SocialPreviewImageOptimizer,
  socialPreviewImageViewModel,
} from "../media/social-images";
import {
  type SemanticDetailsViewModel,
  semanticDetailsViewModel,
} from "../metadata/semantic-metadata";
...
} from "../references/citations/article-citation";
import {
  type ArticleEntry,
  type AuthorEntry,
  bibliographyUrl,
