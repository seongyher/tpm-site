...
} from "../../../../src/lib/deployment/deployment-adapters";
import { createOutputVerificationReport } from "../../../../src/lib/diagnostics/output-verification";
import {
...
} from "../../../../src/lib/release/release-governance";
...
const breakingRouteChange = {
  area: "routes",
  impact: "breaking",
  source: "../../../../src/lib/release/src/lib/routes",
