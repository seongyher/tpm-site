...
- `docs/authoring/AUTHORING_WORKFLOW.md` and `docs/authoring/ARTICLE_REFERENCE_AUTHORING.md`
  explain deeper author workflows and citation rules.
- `docs/platform/HOMEPAGE_CONTENT_MODEL.md`, `docs/authoring/SITE_THEME_CONTRACT.md`, and related
...
- `agent-docs/core/ENGINEERING_PHILOSOPHY.md` is the durable engineering decision
  aid for substantial platform work.
- `agent-docs/roadmap/PLATFORM_ROADMAP.md` is the long-term platform and productization
  roadmap.
- `docs/platform/SOURCE_CONTRACTS.md` defines Milestone 1 source contracts.
- `docs/qa/TEST_MATRIX_AND_FIXTURE_STRATEGY.md`,
  `docs/platform/GENERATED_OUTPUT_VERIFIER_CONTRACT.md`, and performance docs define
  later platform verification contracts.
- `docs/platform/PLATFORM_MODULES.md` maps current platform domains, internal public
  entrypoints, and package-boundary intent.
- `docs/platform/STARTER_TEMPLATES.md` defines maintained starter personas, source
  roots, verification, and release expectations.
- `docs/operations/EXTENSION_ARCHITECTURE.md`,
  `docs/operations/DEPLOYMENT_ADAPTER_CONTRACT.md`,
  `docs/governance/IMPORT_EXPORT_AND_PRESERVATION_POLICY.md`,
  `docs/governance/LOCALIZATION_CONTRACTS.md`, `docs/governance/RELEASE_GOVERNANCE.md`,
  `docs/governance/STATIC_OUTPUT_SECURITY.md`,
  `docs/studio/STUDIO_CREDENTIAL_AND_PROVIDER_SECURITY.md`, and
  `docs/governance/SUPPLY_CHAIN_AND_SECRET_POLICY.md` define Milestone 5 platform
...
- `docs/platform/PUBLIC_DOCUMENTATION_SITE.md` defines the docs-site information
...
- `docs/platform/STARTER_TEMPLATES.md` is the maintained starter contract.
...
- Current surfaces: `site/README.md`, `docs/platform/HOMEPAGE_CONTENT_MODEL.md`,
  `docs/authoring/SITE_THEME_CONTRACT.md`, docs-site configuration pages, generated site
  config schemas.
...
- Current surfaces: `examples/docs-site/**` plus
  `docs/platform/PUBLIC_DOCUMENTATION_SITE.md`.
...
- Current surfaces: `docs/platform/STARTER_TEMPLATES.md`,
...
- Starter template, starter registry, or example site changes: update
  `docs/platform/STARTER_TEMPLATES.md`, starter README files, docs-site examples when
...
- Platform entrypoint or productization contract changes: update
  `docs/platform/PLATFORM_MODULES.md` plus the relevant domain contract such as
