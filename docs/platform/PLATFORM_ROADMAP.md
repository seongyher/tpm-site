...
The current file contract is documented in `docs/authoring/SITE_THEME_CONTRACT.md`.
...
The current command contract is documented in `docs/authoring/AUTHORING_WORKFLOW.md`.
...
`docs/platform/PLATFORM_MODULES.md`. New reusable modules should either fit that map or
...
`docs/audits/PLATFORM_CONFIGURABILITY_AUDIT.md`.
...
The current cleanup plan lives in `docs/platform/PUBLIC_PLATFORM_CLEANUP.md`.
