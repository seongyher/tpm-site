...
- Routes and features
  ...
  [`METADATA_GRAPH_AND_SEMANTIC_PROFILES.md`](../metadata/METADATA_GRAPH_AND_SEMANTIC_PROFILES.md).
- Article rendering
...
- Media policy
  ...
  [`MEDIA_POLICY_AND_PROVIDER_ADAPTERS.md`](../operations/MEDIA_POLICY_AND_PROVIDER_ADAPTERS.md).
...
- Output verification
  ...
  [`RELEASE_GOVERNANCE.md`](../governance/RELEASE_GOVERNANCE.md).
  Static-output trust boundaries and security headers are documented in
  [`STATIC_OUTPUT_SECURITY.md`](../governance/STATIC_OUTPUT_SECURITY.md).
  ...
  [`SUPPLY_CHAIN_AND_SECRET_POLICY.md`](../governance/SUPPLY_CHAIN_AND_SECRET_POLICY.md).
- Deployment adapters
...
- Observability
  ...
  [`OBSERVABILITY_AND_WEBMASTER_REPORTS.md`](../metadata/OBSERVABILITY_AND_WEBMASTER_REPORTS.md).
- Studio readiness
  ...
  [`STUDIO_READINESS_CONTRACTS.md`](../studio/STUDIO_READINESS_CONTRACTS.md).
- Extension architecture
  ...
  [`EXTENSION_ARCHITECTURE.md`](../operations/EXTENSION_ARCHITECTURE.md).
- References and bibliography
  ...
  [`CITATION_SOURCE_MODEL.md`](../citations/CITATION_SOURCE_MODEL.md).
...
- Import/export
  ...
  [`IMPORT_EXPORT_AND_PRESERVATION_POLICY.md`](../governance/IMPORT_EXPORT_AND_PRESERVATION_POLICY.md).
- Localization
  ...
  [`LOCALIZATION_CONTRACTS.md`](../governance/LOCALIZATION_CONTRACTS.md).
- Starter templates
