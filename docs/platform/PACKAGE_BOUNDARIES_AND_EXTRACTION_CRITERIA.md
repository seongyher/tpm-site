...
| Generated-output verification             | `output-verification`, Rust output verifier tasks                      | Static-output verifier core plus CLI/report adapters                        | Medium-high | Route all release and site-doctor diagnostics through a shared diagnostic identity model                   |
