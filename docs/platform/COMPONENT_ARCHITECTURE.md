...
The site anatomy contract lives in `docs/authoring/SITE_ANATOMY.md`. When there is a
...
`docs/platform/HOMEPAGE_CONTENT_MODEL.md`. Articles and announcements share one
...
social preview image pipeline documented in `docs/metadata/SOCIAL_PREVIEW_IMAGES.md` so
