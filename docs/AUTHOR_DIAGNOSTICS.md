...
- config diagnostics: `docs/SITE_ANATOMY.md`,
  `docs/HOMEPAGE_CONTENT_MODEL.md`, or generated site-config references;
- authoring diagnostics: `docs/AUTHORING_WORKFLOW.md`;
- citation diagnostics: `docs/ARTICLE_REFERENCE_AUTHORING.md`;
- metadata diagnostics: `docs/METADATA_GRAPH_AND_SEMANTIC_PROFILES.md`;
- media diagnostics: `docs/MEDIA_POLICY_AND_PROVIDER_ADAPTERS.md`;
- generated-output diagnostics: `docs/GENERATED_OUTPUT_VERIFIER_CONTRACT.md`.
