...
- [CLI_DESIGN_GUIDE.md](../agent-docs/CLI_DESIGN_GUIDE.md)
- [TPM_CLI_PRODUCT_STRATEGY.md](../agent-docs/TPM_CLI_PRODUCT_STRATEGY.md)
- [RUST_MIGRATION_AND_CLI_PLAN.md](../agent-docs/RUST_MIGRATION_AND_CLI_PLAN.md)
- [CLI_RUST_GUI_INTEGRATION_PLAN.md](../agent-docs/CLI_RUST_GUI_INTEGRATION_PLAN.md)
