...
`docs/citations/CITATION_BIBTEX_AUDIT.md`. The structural audit proves that the corpus
...
`docs/citations/CITATION_CANONICAL_VERIFICATION.md`; the per-entry lookup ledger is
`docs/citations/CITATION_CANONICAL_VERIFICATION_LEDGER.md`.
...
2. A diff review of `docs/citations/CITATION_BIBTEX_AUDIT.md` to prove marker/entry
